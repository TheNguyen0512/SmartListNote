...
class NoteListScreenState extends State<NoteListScreen> {
  ...
  void _onTabTapped(int index) async {
    ...
    if (index == 1) {
      const url = 'https://readdy.ai/home/93f9ccd5-e659-4e91-b6da-4f1c6c2c387c/234832b4-c196-4fdd-96f9-2cc5f32fdd0d';
              ...
              child: provider.notes.isEmpty
                        ...
                        Center(
                          child: Column(
                            children: [
                              ...
                              SizedBox(height: AppSizes.spacingMedium(context)),
                              Text(
                                localizations.getString('noNotes'),
                  ...
                  : Padding(
                      ...
                      child: ListView.separated(
                        ...
                        separatorBuilder: (context, index) => SizedBox(height: AppSizes.spacingMedium(context)),
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: note.isCompleted ? AppColors.primary : Colors.transparent,
                                      ),
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                ...
                                                style: TextStyle(
                                                  fontSize: 16,
                                                  color: note.isCompleted ? Colors.grey.shade400 : Colors.grey.shade800,
                                    ...
                                    onPressed: () {
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          final localizations = AppLocalizations.of(context)!;
                                          return AlertDialog(
                                            title: Text(localizations.getString('confirmDeleteTitle')),
                                            content: Text(localizations.getString('confirmDeleteMessage')),
                                            actions: [
                                              TextButton(
                                              ...
                                              TextButton(
                                                onPressed: () async {
                                                  ...
                                                  if (provider.errorMessage == null) {
                                                    _showSnackBar(localizations.getString(provider.syncStatus ?? 'noteDeleted'));
                                                  } else {
                                                    _showSnackBar(localizations.getString(provider.errorMessage!));
                                                  }
                                                },
                                                child: Text(
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () async {
            await Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => AddNoteScreen(onShowSnackBar: _showSnackBar),
              ),
            );
          },
          backgroundColor: AppColors.primary,
